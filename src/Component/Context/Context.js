    ...
    return (
        class Context extends Component {
            sourceShoes = [
                ...
                { id: 24, name: 'Dunk Low', date: '14/04/2021', po: true, poLong: 7, brand: 'Nike', isLike: false, category: 'Lifestyle', price: 3645000, bg: 'linear-gradient(rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.15) 100%), #D2CCE6' },
            ]
            state = {
